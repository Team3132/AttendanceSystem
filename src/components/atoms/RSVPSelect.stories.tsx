...
import { AuthStatusDto, Rsvp, User } from "../../generated";
import SWRConfigWithFetcher from "../SWRProviderWithFetcher";
import RSVPSelect from "./RSVPSelect";

// More on default export: https://storybook.js.org/docs/react/writing-stories/introduction#default-export
export default {
  title: "Atoms/RSVPSelect",
  component: RSVPSelect,
  args: {
    eventId: "cl6def3iu001401n0t7f9zlj6",
  },
  // More on argTypes: https://storybook.js.org/docs/react/api/argtypes
} as ComponentMeta<typeof RSVPSelect>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: ComponentStory<typeof RSVPSelect> = (args) => (
