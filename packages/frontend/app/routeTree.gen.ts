...
import { Route as UnauthenticatedImport } from './../src/pages/_unauthenticated'
import { Route as AuthenticatedImport } from './../src/pages/_authenticated'
import { Route as AuthenticatedIndexImport } from './../src/pages/_authenticated/index'
import { Route as UnauthenticatedLoginImport } from './../src/pages/_unauthenticated/login'
import { Route as AuthenticatedProfileImport } from './../src/pages/_authenticated/profile'
import { Route as AuthenticatedLeaderboardImport } from './../src/pages/_authenticated/leaderboard'
import { Route as AuthenticatedEventsImport } from './../src/pages/_authenticated/events'
import { Route as AuthenticatedAdminImport } from './../src/pages/_authenticated/admin_'
import { Route as AuthenticatedProfileIndexImport } from './../src/pages/_authenticated/profile/index'
import { Route as AuthenticatedAdminIndexImport } from './../src/pages/_authenticated/admin_/index'
import { Route as AuthenticatedProfilePendingImport } from './../src/pages/_authenticated/profile/pending'
import { Route as AuthenticatedEventsCreateImport } from './../src/pages/_authenticated/events_/create'
import { Route as AuthenticatedEventsEventIdImport } from './../src/pages/_authenticated/events_/$eventId'
import { Route as AuthenticatedEventsEventIdIndexImport } from './../src/pages/_authenticated/events_/$eventId/index'
import { Route as AuthenticatedEventsEventIdQrCodeImport } from './../src/pages/_authenticated/events_/$eventId/qr-code'
import { Route as AuthenticatedEventsEventIdCheckInImport } from './../src/pages/_authenticated/events_/$eventId/check-in'
import { Route as AuthenticatedAdminUsersUserIdImport } from './../src/pages/_authenticated/admin_/users.$userId'
import { Route as AuthenticatedAdminUsersUserIdIndexImport } from './../src/pages/_authenticated/admin_/users.$userId/index'
import { Route as AuthenticatedAdminUsersUserIdPendingImport } from './../src/pages/_authenticated/admin_/users.$userId/pending'
