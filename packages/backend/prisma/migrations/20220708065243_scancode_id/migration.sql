/*
  ...
  - The `id` column on the `Scancode` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
ADD CONSTRAINT "Scancode_pkey" PRIMARY KEY ("id");
